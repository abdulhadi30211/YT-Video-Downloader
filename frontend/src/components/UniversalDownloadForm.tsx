...
import { Loader2, Download, Globe, Link, Sparkles } from 'lucide-react';
import { showError } from '@/utils/toast';
import { withSmartlink } from '@/utils/ad-integration';

interface UniversalDownloadFormProps {
  onFetchInfo: (url: string) => void;
  isLoading: boolean;
}

const UniversalDownloadForm: React.FC<UniversalDownloadFormProps> = ({ onFetchInfo, isLoading }) => {
    ...
    <form onSubmit={handleSubmit} className="w-full max-w-2xl space-y-6">
      <div className="text-center space-y-4">
        ...
        <p className="text-lg text-muted-foreground max-w-md mx-auto">
          Download videos from any website - YouTube, Facebook, Instagram, TikTok, and more!
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 text-center">
        <div className="p-3 rounded-lg bg-secondary/50">
          <div className="text-2xl font-bold text-primary">All Sites</div>
...
export default UniversalDownloadForm;